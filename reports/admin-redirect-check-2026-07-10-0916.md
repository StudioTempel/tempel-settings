# Admin redirect check (2026-07-10-0916)
...
- `cocorico.nl/st-beheer/`: HTTP `404`, redirects `3`, final `https://www.cocorico.nl/st-beheer/?doing_wp_cron=1783667796.6774969100952148437500`
...
- `ofmedemblik.nl/st-beheer/`: HTTP `404`, redirects `3`, final `https://www.ofmedemblik.nl/st-beheer/?doing_wp_cron=1783667785.4052538871765136718750`
- `pgenkhuizen.nl/st-beheer/`: HTTP `404`, redirects `2`, final `https://www.pgenkhuizen.nl/st-beheer/`
- `quicksilverbar.nl/st-beheer/`: HTTP `404`, redirects `2`, final `http://www.quicksilverbar.nl/st-beheer/?doing_wp_cron=1783667787.3245489597320556640625`
...
- `bvscout.nl/st-beheer/`: HTTP `301`, redirects `1`, final `https://bvscout.nl/st-beheer/`, error `Operation timed out after 12003 milliseconds with 0 bytes received`
- `bvscout.nl/wp-admin/`: HTTP `301`, redirects `1`, final `https://bvscout.nl/wp-admin/`, error `Operation timed out after 12003 milliseconds with 0 bytes received`
- `deslimmechef.nl/wp-admin/`: HTTP `302`, redirects `2`, final `https://deslimmechef.nl/wp-login.php?redirect_to=https%3A%2F%2Fdeslimmechef.nl%2Fwp-admin%2F&reauth=1`, error `Operation timed out after 3014 milliseconds with 0 bytes received`
- `horizonflowerfamily.nl/st-beheer/`: HTTP `301`, redirects `2`, final `https://www.horizonflowerfamily.nl/st-beheer/`, error `Operation timed out after 3343 milliseconds with 0 bytes received`
- `horizonflowerfamily.nl/wp-admin/`: HTTP `302`, redirects `2`, final `https://www.horizonflowerfamily.nl/wp-login.php?redirect_to=https%3A%2F%2Fhorizonflowerfamily.nl%2Fwp-admin%2F&reauth=1`, error `Operation timed out after 3328 milliseconds with 0 bytes received`
...
## WP_ADMIN_REDIRECT (22)

- `bierfabriek.com/wp-admin/`: HTTP `200`, redirects `2`, final `https://www.bierfabriek.com/`
- `cocorico.nl/wp-admin/`: HTTP `200`, redirects `3`, final `https://www.cocorico.nl/wp-login.php?redirect_to=https%3A%2F%2Fcocorico.nl%2Fwp-admin%2F%3Fdoing_wp_cron%3D1783667798.7087619304656982421875&reauth=1`
...
- `ofmedemblik.nl/wp-admin/`: HTTP `200`, redirects `3`, final `https://www.ofmedemblik.nl/wp-login.php?redirect_to=https%3A%2F%2Fofmedemblik.nl%2Fwp-admin%2F%3Fdoing_wp_cron%3D1783667785.8224179744720458984375&reauth=1`

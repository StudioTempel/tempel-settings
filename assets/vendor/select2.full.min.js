...
!(function (n) {
  ...
  ((u = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : u) &&
    ...
    (o = function (e, t, n, s) {
      ...
      if ("undefined" == u || "function" == u) {
        for (
          ...
          else if (b(g, o) || b(m, o) || b(v, o)) c[a] = x(o);
          else {
    ...
    u.define("select2/results", ["jquery", "./utils"], function (u, d) {
      ...
      return (
        ...
        (s.prototype.option = function (e) {
          ...
          for (t in (((null != e.element && i.call(e.element, ":disabled")) ||
        ...
        (s.prototype.bind = function (t, e) {
          ...
          this.$results.attr("id", n),
            ...
            t.on("select", function () {
              t.isOpen() &&
                (i.setClasses(), i.options.get("scrollAfterSelect")) &&
            ...
            t.on("results:previous", function () {
              ...
              s <= 0 ||
                ((s = s - 1),
                0 === t.length && (s = 0),
                (t = n.eq(s)).trigger("mouseenter"),
                (n = i.$results.offset().top),
                (t = t.offset().top),
                (e = i.$results.scrollTop() + (t - n)),
                0 === s
                  ? i.$results.scrollTop(0)
                  : t - n < 0 && i.$results.scrollTop(e));
            }),
            t.on("results:next", function () {
              var e,
                ...
                n = s.index(n) + 1;
              n >= s.length ||
                ((s = s.eq(n)).trigger("mouseenter"),
                (e = i.$results.offset().top + i.$results.outerHeight(!1)),
                (s = s.offset().top + s.outerHeight(!1)),
                (t = i.$results.scrollTop() + s - e),
                0 === n
                  ? i.$results.scrollTop(0)
                  : e < s && i.$results.scrollTop(t));
            }),
              ...
              function (e) {
                ...
                t.hasClass("select2-results__option--selected")
                  ? i.options.get("multiple")
                    ...
                    : i.trigger("close", { originalEvent: e, data: n })
            ...
            this.$results.on(
              ...
              function (e) {
                ...
                i
                  ...
                  i.trigger("results:focus", { data: t, element: u(this) });
              },
            );
        }),
      ...
      function (e, t, n, s) {
        ...
        return (
          ...
          (i.prototype.bind = function (t, e) {
            var n = this,
              s =
                (i.__super__.bind.apply(this, arguments), t.id + "-container");
            this.$selection
      ...
      function (i, e, c) {
        ...
        return (
          ...
          (o.prototype.bind = function (e, t) {
            var n = this,
              s =
                (o.__super__.bind.apply(this, arguments), e.id + "-container");
          ...
          (e.prototype.update = function (e, t) {
            ...
            e.call(this, t),
              ...
              0 <
                ...
                s.attr("aria-label", n()),
                s.attr("aria-describedby", e),
                a.StoreData(s[0], "data", t),
      ...
      return (
        (e.prototype.render = function (e) {
          ...
          return (
            -1 !== t.indexOf(":all:") &&
              ((t = t.replace(":all:", "")),
              n.copyNonInternalCssClasses(e[0], this.$element[0])),
            e.addClass(t),
            e
          );
        }),
    ...
    u.define("select2/translation", ["jquery", "require"], function (t, n) {
      ...
      return (
        ...
        (s.loadPath = function (e) {
          var t;
          return (
            e in s._cache || ((t = n(e)), (s._cache[e] = t)), new s(s._cache[e])
          );
        }),
        s
      );
          ...
          (s.prototype.convertToOptions = function (e) {
            ...
            for (var o = 0; o < e.length; o++) {
              ...
              0 <= s.indexOf(l.id)
                ...
                : ((r = this.option(l)),
                  l.children &&
                    ((a = this.convertToOptions(l.children)), r.append(a)),
                  i.push(r));
            }
            return i;
          }),
        ...
        (e.prototype.query = function (e, t, n) {
          ...
          var i = this.tokenizer(t, this.options, function (e) {
            ...
            s.$element.find("option").filter(function () {
              ...
              ((e = s.option(t)).attr("data-select2-tag", !0),
              s._removeOldTags(),
              s.addOptions([e])),
          ...
          (e.prototype.highlightFirstItem = function (e) {
            ...
            if (0 < t.length) {
              ...
              if (
                ...
                return void t.trigger("mouseenter");
            }
            e.call(this);
          }),
          e
        ...
        return (
          ...
          (n.prototype.applyFromElement = function (e, t) {
            var n = e.language,
              ...
              i = t.prop("lang"),
              t = t.closest("[languages]").prop("lang"),
              i = Array.prototype.concat.call(
      ...
      function (t, i, o, s) {
        ...
        return (
          ...
          (r.prototype._resolveWidth = function (e, t) {
            ...
            if ("resolve" == t)
              return null != (s = this._resolveWidth(e, "style"))
                ? s
          ...
          (r.prototype.trigger = function (e, t) {
            ...
            if ((void 0 === t && (t = {}), e in s)) {
              ...
              if ((n.call(this, s[e], i), i.prevented))
    ...
    (i = function (c) {
      ...
      function s(e) {
        ...
        if (
          ...
          return (
            1 === n.deltaMode
              ? ((i *= t = c.data(this, "mousewheel-line-height")),
                (r *= t),
                (o *= t))
              : 2 === n.deltaMode &&
                ((i *= t = c.data(this, "mousewheel-page-height")),
                (r *= t),
                (o *= t)),
            (t = Math.max(Math.abs(r), Math.abs(o))),
            (!d || t < d) && g(n, (d = t)) && (d /= 40),
            g(n, t) && ((i /= 40), (o /= 40), (r /= 40)),
            ...
            u && clearTimeout(u),
            (u = setTimeout(f, 200)),
            (c.event.dispatch || c.event.handle).apply(this, s)
          );
      }
      function f() {
        d = null;
    ...
    "function" == typeof u.define && u.define.amd
      ? u.define("jquery-mousewheel", ["jquery"], i)
  ...
  function x(e) {
    var t;
    if (
      (b(m, e) && ((t = m[e]), delete m[e], (v[e] = !0), o.apply(p, t)),
      b(g, e) || b(v, e))
    )
      return g[e];

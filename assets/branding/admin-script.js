jQuery(document).ready(function () {
        ...
        jQuery("#submitdiv a.submitdelete").text(jQuery("#submitdiv a.submitdelete").text().replace("Verplaatsen naar prullenbak", "Naar prullenbak"));
        jQuery("#postimagediv a#remove-post-thumbnail").text(jQuery("#postimagediv a#remove-post-thumbnail").text().replace("Uitgelichte afbeelding verwijderen", ""));

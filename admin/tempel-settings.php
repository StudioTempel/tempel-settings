...
$logo = $dir . 'assets/images/admin-logo.svg';



require plugin_dir_path(__FILE__) . '/vendor/plugin-update-checker-5.2/plugin-update-checker.php';
...
//
// @Summary: Remove WP logo from admin bar
//
// @parameters: $wp_admin_bar
//
...
//
// @Summary: Add field to options page
//
// @parameters: none
//
...
//
// @Summary: Disables dashboard widgets if option is checked
//
// @parameters: $dashboard_widgets
// @requires: ACF
//
...
if (function_exists('get_option')) {
    ...
    if (get_option('tempel-settings-data')) {
        $dashboard_widgets = get_option('tempel-settings-data')['hide_dashboard_widgets_bool'];
    } else {
        $dashboard_widgets = 'off';
    }

    if ($dashboard_widgets == 'on') {
...
//
// @Summary: Adds custom logo to admin bar
//
// @parameters: none
//
...
//
// @Summary: Enqueues custom admin styles and scripts
//
// @parameters: none
//
...
if (!is_admin()) {
    ...
    wp_enqueue_style('tempel-settings-styles', '' . plugin_dir_url(__FILE__) . '/dist/css/styles.css');
}
...
//
// @Summary: Creates ACF options page for plugin
//
// @parameters: none
//
...
//
// @Summary: Removes the ability to comment
//
// @parameters: none
//
...
// include 'admin/class-tempel-options-page.php';
